...
var Upload = /** @class */ (function (_super) {
    ...
    function Upload() {
        ...
        _this.onChange = function (info) {
            ...
            if (status === 'done' && _this.props.onUploadSuccess) {
                _this.props.onUploadSuccess(info.file);
            }
    ...
    Upload.prototype.render = function () {
        var _a = this.props, url = _a.url, props = __rest(_a, ["url"]);
        var accessToken = AuthSession.current().accessToken;
        var headers = {};
        if (accessToken) {
            headers.authorization = "Bearer " + accessToken;
        }
        return (React.createElement(AntdUpload.Dragger, __assign({}, props, { name: "file", multiple: true, action: url, onChange: this.onChange, headers: headers }),

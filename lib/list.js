...
var FilesList = /** @class */ (function (_super) {
    ...
    function FilesList() {
        ...
        _this.getItemURL = function (hostURL, item) {
            var token = AuthSession.current().accessToken;
            return hostURL + "/" + item.uid + "?access_token=" + token;
        };
        _this.openItem = function (hostURL, item) { return __awaiter(_this, void 0, void 0, function () {
            var url;
    ...
    FilesList.prototype.render = function () {
        var _this = this;
        var _a = this.props, dataSource = _a.dataSource, referenceColumn = _a.referenceColumn, referenceID = _a.referenceID, uploadURL = _a.uploadURL, hostURL = _a.hostURL, initialFilters = _a.initialFilters, readonly = _a.readonly;
        var filters = {};
        if (referenceID) {
                        ...
                        return (React.createElement(List.Item, { actions: [
                            ...
                            React.createElement("div", { className: "file-list__item" },
                                React.createElement("div", null,
                                    React.createElement("a", { onClick: function () { return _this.openItem(hostURL, item); }, href: "#" },

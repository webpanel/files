...
var FilesList = /** @class */ (function (_super) {
    ...
    FilesList.prototype.render = function () {
        ...
        return (React.createElement(ResourceCollectionLayer, { name: "files", key: "files_" + this.props.referenceID, fields: ["id", "name", "createdAt", "size"], initialLimit: 5, initialOffset: 0, initialFilters: filters, initialSorting: [
                {
                    columnKey: "createdAt",

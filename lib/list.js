...
export var FilesList = function (props) {
    var dataSource = props.dataSource, referenceColumn = props.referenceColumn, referenceID = props.referenceID, uploadURL = props.uploadURL, hostURL = props.hostURL, initialFilters = props.initialFilters, readonly = props.readonly, accessToken = props.accessToken, thumbnails = props.thumbnails, extra = props.extra;
    ...
    var _a = React.useState({}), selectedFiles = _a[0], setSelectedFiles = _a[1];
    var selectedKeys = Object.keys(selectedFiles);
    var selectedCount = selectedKeys.length;
    var fields = ["id", "name", "createdAt", "size"];
    if (thumbnails) {
    ...
    return (React.createElement(SpinningCard, { observedResource: files, title: t("files"), bodyStyle: { padding: 16 }, extra: [
            ...
            React.createElement(DeleteButton, { onDelete: function () { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4 /*yield*/, Promise.all(Object.keys(selectedFiles).map(function (id) {
        ...
        React.createElement("div", { className: "file-list__select-all" },
            t("select_all"),
            " ",
        ...
        React.createElement(List, { size: "small", itemLayout: "horizontal", dataSource: files.data || undefined, pagination: {
                position: "bottom",
                defaultPageSize: 5,
            }, renderItem: function (item) {
                return (React.createElement(List.Item, { key: item.id, style: { padding: 8 }, actions: [
                        React.createElement(Checkbox, { onChange: function () {
                                var values = __assign({}, selectedFiles);
                                if (values[item.id]) {
        ...
        !readonly && (React.createElement(Upload, { url: uploadURL + "?reference=" + props.referenceID + "&" + props.referenceColumn + "=" + props.referenceID, accessToken: accessToken, onUploadSuccess: function (response) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            }); }, onUploadError: function () { return message.error(t("file_upload_failed")); }, style: { marginTop: 20 } }))));
};

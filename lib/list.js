...
var FilesList = /** @class */ (function (_super) {
    ...
    function FilesList() {
        ...
        _this.getItemURL = function (hostURL, item, token) {
            return hostURL + "/" + item.uid + "?access_token=" + token;
        };
        _this.openItem = function (hostURL, item, token) { return __awaiter(_this, void 0, void 0, function () {
            var url;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.getItemURL(hostURL, item, token), {
                            method: "GET",
    ...
    FilesList.prototype.render = function () {
        var _this = this;
        var _a = this.props, dataSource = _a.dataSource, referenceColumn = _a.referenceColumn, referenceID = _a.referenceID, uploadURL = _a.uploadURL, hostURL = _a.hostURL, initialFilters = _a.initialFilters, readonly = _a.readonly, accessToken = _a.accessToken;
        var filters = {};
        if (referenceID) {
            filters[referenceColumn || "reference"] = referenceID;
        }
        filters = __assign({}, filters, initialFilters);
        return (React.createElement(ResourceCollectionLayer, { name: "files", key: "files_" + this.props.referenceID, fields: ["id", "uid", "name", "createdAt", "size"], initialLimit: 5, initialOffset: 0, initialFilters: filters, initialSorting: [
                {
                    columnKey: "createdAt",
                            ...
                            React.createElement("div", { className: "file-list__item" },
                                React.createElement("div", null,
                                    React.createElement("a", { onClick: function () {
                                            return _this.openItem(hostURL, item, accessToken);
                                        }, href: "#" },
                ...
                !readonly && (React.createElement(Upload, { url: uploadURL + "?reference=" + _this.props.referenceID + "&" + _this.props.referenceColumn + "=" + _this.props.referenceID, accessToken: accessToken, onUploadSuccess: function () {

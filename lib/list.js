...
var FilesList = /** @class */ (function (_super) {
    ...
    FilesList.prototype.render = function () {
        var _this = this;
        var _a = this.props, dataSource = _a.dataSource, fileUploadURL = _a.fileUploadURL;
        return (React.createElement(ResourceCollectionLayer, { name: "files", key: "files_" + this.props.referenceID, fields: ['id', 'name', 'url', 'createdAt', 'size'], initialLimit: 5, initialOffset: 0, initialFilters: { reference: this.props.referenceID }, initialSorting: [
                {
                    columnKey: 'createdAt',
                ...
                React.createElement(List, { size: "small", itemLayout: "horizontal", dataSource: files.data || undefined, renderItem: function (item) {
                        return (React.createElement(List.Item, { actions: [
                                hasAccess('deleteFile') && (React.createElement(DeleteButton, { key: "delete", onDelete: function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                React.createElement(Upload, { url: fileUploadURL + "?reference=" + _this.props.referenceID + "&" + _this.props.referenceColumn + "=" + _this.props.referenceID, onUploadSuccess: function () {

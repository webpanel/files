...
var FilesList = /** @class */ (function (_super) {
    ...
    FilesList.prototype.render = function () {
        var _this = this;
        var _a = this.props, dataSource = _a.dataSource, referenceColumn = _a.referenceColumn, referenceID = _a.referenceID, uploadURL = _a.uploadURL, initialFilters = _a.initialFilters;
        var filters = {};

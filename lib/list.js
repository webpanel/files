...
export var FilesList = function (props) {
    ...
    return (React.createElement(SpinningCard, { observedResource: files, title: "Soubory" },
        React.createElement(List, { size: "small", itemLayout: "horizontal", dataSource: files.data || undefined, renderItem: function (item) {
                return (React.createElement(List.Item, { actions: [
                        React.createElement(DeleteButton, { key: "delete", onDelete: function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        !readonly && (React.createElement(Upload, { url: uploadURL + "?reference=" + props.referenceID + "&" + props.referenceColumn + "=" + props.referenceID, accessToken: accessToken, onUploadSuccess: function () {

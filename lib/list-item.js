...
var imagePlaceholder = React.createElement(Spin, { style: { width: "100%" } });
export var ListItem = function (props) {
    ...
    var tooltipContent = item.largeThumbnail && (React.createElement("div", null,
        React.createElement(Image, { width: 250, src: item.largeThumbnail.url, placeholder: imagePlaceholder })));
    ...
    return (React.createElement("div", { className: "file-list__item" },
        item.smallThumbnail && (React.createElement("div", { className: "file-list__thumbnail" },
            React.createElement(Popover, { content: tooltipContent, placement: "left" },
                React.createElement(Image, { src: item.smallThumbnail.url, width: 50, preview: false, placeholder: imagePlaceholder })))),
        React.createElement("div", { className: "file-list__content" },
            React.createElement("div", null,
                React.createElement(Typography.Text, { style: { maxWidth: "100%" }, title: item.name, ellipsis: true },
                    React.createElement("a", { onClick: function () { return openItem(hostURL, item, accessToken); }, href: "#" }, item.name || React.createElement("i", null, "[unnamed_file]")))),

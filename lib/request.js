...
function getError(options, xhr) {
    var msg = "cannot " + options.method + " " + options.action + " " + xhr.status + "'";
...
var getPresignedUrl = function (options) { return __awaiter(_this, void 0, void 0, function () {
    return __generator(this, function (_a) {
        return [2 /*return*/, fetch(options.action, {
                ...
                headers: __assign({}, options.headers, { "Content-Type": "application/json" }),
            })
                .then(function (res) { return res.json(); })
                .then(function (json) { return json.uploadURL; })];
    });
}); };
export function UploadRequest(options) {
    ...
    if (options.onProgress && xhr.upload) {
        xhr.upload.onprogress = function progress(e) {
            var event = __assign({}, e, { percent: 0 });
            if (e.total > 0) {
    ...
    getPresignedUrl(options).then(function (uploadURL) {
